...
public class AdminController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        if(path.equals("/admin/user")) {
        ...
        else if(path.equals("/admin/user-modal")) {
        	...
        	List<AdminUserDto> userList = userDao.getAllUsersByTeamIsNull(userName);
            ...
            dispatcher = getServletContext().getRequestDispatcher("/userlist_modal.jsp");
        }
        else {
            // 404 페이지
